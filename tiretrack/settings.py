...
MIDDLEWARE = [
    ...
    'warehouse.middleware.RequestLoggingMiddleware',
]
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='tire-management'),
...
AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # Email is treated as username field
]
